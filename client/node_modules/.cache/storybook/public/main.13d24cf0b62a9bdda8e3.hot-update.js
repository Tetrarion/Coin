...
Button.propTypes = {
  ...
  */
  ...
  The display content of the button
  */
  func: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func.isRequired)
};
...
Button.__docgenInfo = {
  ...
  "props": {
    "type": {
      ...
      "required": true,
      "description": "Checks if the button should be disabled"
    },
    "text": {
      "type": {
        "name": "string"
      ...
      "required": true,
      "description": "The display content of the button"
    },
    "func": {
      "type": {
        "name": "func"
...
//# sourceMappingURL=main.13d24cf0b62a9bdda8e3.hot-update.js.map